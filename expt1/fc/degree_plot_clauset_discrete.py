...
def plot(degree, option, num_layers, hidden_units, layer, adjust_axis, xaxis_labels, xaxis_tick_labels):
    ...
    p.savefig(
        'figures/layer/powerlaw_clauset_99/mnist05_{0}_{1}_{2}_{3}.png'.format(option, num_layers, hidden_units, layer),
        bbox_inches='tight')
...
def main(filename, option, num_layers, hidden_units, adjust_axis):
    ...
    if "_8_" in filename:
        ...
        xaxis_labels_all = [[3,81], [72,125], [41,90]]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, dest="filename",
                        default='model/sparse_model_0.95_2_1024.npz')
