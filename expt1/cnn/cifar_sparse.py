...
def load_dataset():
    ...
    preprocessor = serial.load(
        "/home/eric/Desktop/powerLaw/power-law/expt3/cnn/cifar10/pylearn2_gcn_whitened/preprocessor.pkl")
    train_set = ZCA_Dataset(
        preprocessed_dataset=serial.load(
            "/home/eric/Desktop/powerLaw/power-law/expt3/cnn/cifar10/pylearn2_gcn_whitened/train.pkl"),
    ...
    test_set = ZCA_Dataset(
        preprocessed_dataset=serial.load(
            "/home/eric/Desktop/powerLaw/power-law/expt3/cnn/cifar10/pylearn2_gcn_whitened/test.pkl"),
        preprocessor=preprocessor)
    # bc01 format
...
def main(prune_fraction, num_epochs=500):
    ...
    train_fn = theano.function([input_var, target_var], [loss, W_grads[0], W_grads[2], W_grads[4]], updates=updates,allow_input_downcast=True)
    ...
    for epoch in range(num_epochs):
        ...
        if val_acc > best_val_acc:
            ...
            np.savez('cifar/model/sparse_cnn_{0}.npz'.format(prune_fraction),
        ...
        with open("cifar/model/sparse_cnn_{0}.txt".format(prune_fraction), "a") as myfile:
            myfile.write(
                "{0}  {1:.3f} {2:.3f} {3:.3f} {4:.3f} {5:.3f}\n".format(epoch, train_loss, val_loss, val_acc, test_loss,
                                                                        test_acc))
