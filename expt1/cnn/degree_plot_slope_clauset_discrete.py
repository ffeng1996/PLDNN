...
def plot(degree, option, layer, adjust_axis, xaxis_labels):
    ...
    plt.tight_layout()
    p.savefig('figures/powerlaw_clauset_99/mnist_{0}_{1}.png'.format(option, layer), bbox_inches='tight')
...
def main(filename, option, adjust_axis):
    ...
    #for i in range(len(param_values_sparse)):
        #print(param_values_sparse[i].shape)
    #print "#############################"
    '''
    testList = [param_values_sparse[0], param_values_sparse[1], param_values_sparse[2], param_values_sparse[3],param_values_sparse[4],param_values_sparse[5]]
    print "#############################"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", type=str, dest="filename",
                        default='model/sparse_cnn_0.98.npz')
