...
def main(args, ITE=0):
    ...
    if args.dataset == "mnist":
        ...
        from archs.mnist import AlexNet, LeNet5, fc1, vgg, resnet,densenet

    elif args.dataset == "cifar100":
        traindataset = datasets.CIFAR100('../data', train=True, download=True,transform=transform)
        testdataset = datasets.CIFAR100('../data', train=False, transform=transform)   
        from archs.cifar100 import AlexNet, fc1, LeNet5, vgg, resnet,densenet
...
def weight_init(m):
    ...
    Usage:
        model = Model()
        modeITERATIONl.apply(weight_init)
    '''
